  ...
  */
  ...
  class moneyorder {
    ...
    function __construct() {
      ...
      $this->title = OSCOM::getDef('module_payment_moneyorder_text_title');
      $this->description = OSCOM::getDef('module_payment_moneyorder_text_description');
    ...
    function update_status() {
      ...
      if ( ($this->enabled == true) && ((int)MODULE_PAYMENT_MONEYORDER_ZONE > 0) ) {
        $check_flag = false;
        $Qcheck = $OSCOM_Db->get('zones_to_geo_zones', 'zone_id', ['geo_zone_id' => MODULE_PAYMENT_MONEYORDER_ZONE, 'zone_country_id' => $order->delivery['country']['id']], 'zone_id');
        while ($Qcheck->fetch()) {
...
function confirmation() {
    ...
    function check() {
      return defined('MODULE_PAYMENT_MONEYORDER_STATUS');
    }
    ...
    function install() {
      ...
      $OSCOM_Db->save('configuration', [
        'configuration_title' => 'Enable Moneyorder Module',
        'configuration_key' => 'MODULE_PAYMENT_MONEYORDER_STATUS',
        'configuration_value' => 'True',
        'configuration_description' => 'Do you want to accept Moneyorder payments?',
