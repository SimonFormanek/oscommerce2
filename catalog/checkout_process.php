...
// load the before_process function from the payment modules
  ...
  $sql_data_array = array('customers_id' => $_SESSION['customer_id'],
                          ...
                          'customers_company_id' => $order->customer['company_id'],
                          ...
                          'delivery_company_id' => $order->delivery['company_id'],
                          'delivery_vat_id' => $order->delivery['vat_id'],
                          ...
                          'billing_company_id' => $order->billing['company_id'],
                          'billing_vat_id' => $order->billing['vat_id'],
